...
3. **Decompose.** Converge to a decision-complete design (`plan`), break the design into agent-executable issues (`decompose`), and initiate the work session (`take`).
