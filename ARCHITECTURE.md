...
**Core skills** (8) are maintained in this repository. They define the pipeline's structure — what stages exist, what handoff contracts connect them, and what cognitive discipline the pipeline enforces.
